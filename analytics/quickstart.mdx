...
description: Connect your first data source, build a dashboard with charts, and share it with teammates in under 15 minutes using the Analytics workspace.
---
...
- Explore the charts and visualizations guide to learn about all available chart types.{/* TODO: link target page `/analytics/dashboards/charts-visualizations` does not exist yet. */}
