...
description: Add databases, warehouses, and SaaS sources to Analytics, authenticate the connection, configure sync frequency, and troubleshoot common errors.
---
...
Go to **Analytics → Data sources → Add source** and complete the following fields:
