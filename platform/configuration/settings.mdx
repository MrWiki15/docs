...
description: Configure your workspace name, default timezone, language, branding, and display preferences that apply to every project and team member.
---
...
Go to **Settings → General** to access these options.
