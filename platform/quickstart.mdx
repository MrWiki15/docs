...
description: Create your organization, configure workspace settings, invite teammates with roles, and launch your first project in under 20 minutes.
---
...
<Steps>
  ...
  <Step title="Configure general settings">
    Go to **Settings → General** and set your workspace name, timezone, and display preferences. These defaults apply to all new members and projects.
  </Step>
