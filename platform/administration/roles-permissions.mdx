...
description: Assign Admin, Member, and Viewer roles, build custom role definitions, and scope permissions to workspaces and individual projects for your team.
---
