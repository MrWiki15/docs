...
description: Find a connector in the catalog, authenticate it, map fields to your data model, and test the first sync in under 10 minutes from start to finish.
---
