...
description: Register a webhook endpoint, choose the events to subscribe to, verify signatures for security, and retry failed deliveries from the dashboard.
---
...
<Steps>
  ...
  <Step title="Select events">
    ...
    See the event types reference for the full list and payload schemas.{/* TODO: link target page `/integrations/webhooks/event-types` does not exist yet. */}
  </Step>
